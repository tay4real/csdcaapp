...
*/
$aColumns = array( 'cs_no', 'surname', 'firstname', 'othername', 'sex', 'phone', 'photopath','cs_no' );
...
while ( $aRow = mysqli_fetch_array( $rResult ) )
{
    ...
    for ( $i=0 ; $i<count($aColumns) ; $i++ )
    {
        if ( $aColumns[$i] == "photopath" )
        {
            /* Special output formatting for 'version' column */
            $row[] = '<img  src="./saved_images/'.$aRow[ $aColumns[0]].'.jpg" alt="profile thumbnail" width="40" />';
